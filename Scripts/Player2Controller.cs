...
public class Player2Controller : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        bool attackPressed = Input.GetKeyDown(KeyCode.LeftControl); // Assuming Left Control for attack
        bool spinPressed = Input.GetKeyDown(KeyCode.LeftAlt); // Assuming Left Alt for spin
